...
<div>
    ...
    <x-starterkid-frontend::body-content heading="{{$blogpost->name}}" content="{!!$blogpost->content!!}" imgSrc="{{$blogpost->getFirstMediaUrl('images','large')}}" imgSrcMedium="{{$blogpost->getFirstMediaUrl('images','medium')}}" imgSrcMediumLarge="{{$blogpost->getFirstMediaUrl('images','medium-large')}}" imgAlt="{{$blogpost->name}}" imageCredits="{{$blogpost->image_credits}}" dateTime="{{$blogpost->getPublished()}}" author="{{$blogpost->author}}"  />
