...
Route::middleware(['web'])->group(function () {
    ...
    Route::get(config('starterkid-blog.blog_post_slug'),FrontBlogPostIndex::class)->name('front.blog-post.index');
    Route::get(config('starterkid-blog.blog_post_slug').'/{slug}',FrontBlogPostShow::class)->name('front.blog-post.show')->middleware('cache');
